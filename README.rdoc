...
useful for creating activity feeds. <tt>vestial_versions</tt> provides three events
...
* <tt>deleted_version_created</ttd>: Called if you have deletion tracking. 

Here is an example obserer

    class TodoObserver < ActiveRecord::Observer

      def initial_version_create(todo)
